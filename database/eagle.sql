...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-10-2022 a las 04:37:26
...
(1, 'Ommikron', 'Un dos líneas concebido para ofrecer altas prestaciones, satisfacer a los pilotos más experimentados y obtener grandes resultados en competiciones.\r\n', 'Dificil', 2600, 1, 'images/634c902297a07.jpg.jpeg.png'),
...
--
ALTER TABLE `parapentes`
  MODIFY `id_parapente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
